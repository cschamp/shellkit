...
# XXX export LD_LIBRARY_PATH=/usr.local/lib:$LD_LIBRARY_PATH
# XXX export PYTHONPATH=/usr/local/lib/python2.5/site-packages:$PYTHONPATH
export P4CONFIG=.p4config
# XXX [[ -f /Applications/p4merge.app/Contents/MacOS/p4merge ]] && export P4DIFF=/Applications/p4merge.app/Contents/MacOS/p4merge
# XXX [[ -f /usr/bin/chdiff ]] && export P4DIFF="/usr/bin/chdiff --wait"
